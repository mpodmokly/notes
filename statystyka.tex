...
\begin{document}
    ...
    \begin{enumerate}
        ...
        \item $Var(X)=0$ wtedy i tylko wtedy, gdy $X$ jest stała
            ...
            \[
                P(X \neq x_0)=0
            \]
        \item Funkcja $\phi(c)=\mathbb{E}((X-c)^2)$ przyjmuje wartość
            najmniejszą dla $c=\mathbb{E}(X)$
    \end{enumerate}
    ...
    \begin{definition}[Rozkład dwupunktowy]
        ...
        \]
        \[
            K=\frac{1-3\theta+3\theta^2}{\theta(1-\theta)}
        \]
        \[
            \gamma_2=\frac{1-6\theta+6\theta^2}{\theta(1-\theta)}
        \]
        \begin{figure}[H]
            \centering
