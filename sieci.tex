...
\begin{document}
    ...
    \section{Kodowania}
    Manchester koduje zboczem, 0 zbocze malejące, 1 zbocze rosnące. Manchester
    różnicowy też zbocze, ale 0 powtarza poprzednie zbocze, a 1 odwraca poprzednie
    zbocze.
\end{document}
